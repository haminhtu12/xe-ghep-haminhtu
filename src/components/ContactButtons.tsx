...
export default function ContactButtons() {
    ...
    return (
        <>
            ...
            {/* Hide buttons when modal is open to prevent overlapping */}
            {!isBookingModalOpen && (
                <div className="fixed bottom-6 right-6 z-40 flex flex-col gap-3 items-end animate-in fade-in duration-300">
                    ...
                    {/* Zalo Button */}
                    <a
                        href="https://zalo.me/0334909668" // Updated to use the number found in BookingModal (Step 9) or default to user provided
                        target="_blank"
                    ...
                    {/* Phone Button */}
                    <a
                        href="tel:0334909668" // Updated to match Zalo number potentially

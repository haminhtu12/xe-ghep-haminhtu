      ...
      <section className="relative bg-slate-900 text-white pb-32 pt-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-800/50 border border-slate-700 backdrop-blur-sm mb-8 animate-fade-in">
            ...
            <span className="text-sm font-medium text-slate-300">Hơn 5,000+ chuyến xe mỗi ngày</span>
          </div>

          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-6 leading-tight">
            Di chuyển <span className="text-amber-500">Tiện Lợi</span> <br />
            Giá Cả <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-orange-500">Hợp Lý</span>
          </h1>

          <p className="text-lg md:text-xl text-slate-400 max-w-2xl mx-auto mb-10 leading-relaxed">
            Ứng dụng đặt xe ghép, xe tiện chuyến hàng đầu Việt Nam. <br className="hidden md:block" />
            Kết nối trực tiếp hành khách và tài xế - Không qua trung gian.
          </p>
        </div>
      </section>
